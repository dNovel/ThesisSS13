...
Die ToMesh() Methode muss jetzt ein Objekt von dem FUSEE bekannten Typen "Mesh" erzeugen und es an den aufrufer zur"uckgeben. Das so erhaltene Objekt kann in einem FUSEE Projekt mit  RC.Render(Mesh meshObjekt) gerendert werden.
